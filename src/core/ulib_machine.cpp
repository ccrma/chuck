...
DLL_QUERY machine_query( Chuck_DL_Query * QUERY )
{
    ...
    */
    ...
    QUERY->doc_func( QUERY, "evaluate a string as ChucK code, with optional arguments (bundled in 'args' as \"ARG1:ARG2:...\", compile it and sporking 'count' instances, each as an independent shred." );
    QUERY->add_arg( QUERY, "string", "code" );
    QUERY->add_arg( QUERY, "string", "args" );
