...
// desc: terminal code for printing
//
...
public:
    ...
    // enable TC
    static void on();
    // disable TC (passthrough)
    static void off();

public:
    // wrap text; make bold
    static std::string bold( const std::string & text );
    // wrap text; make color, with optional bold attribute
...
public:
    ...
    // set a terminal code
    static std::string set( TerminalCode code ) { return std::string("\033[") + itoa(code) + "m"; }
    static std::string seti( t_CKUINT code ) { return std::string("\033[") + itoa(code) + "m"; }
    static std::string set_fg_default() { return TC::set(FG_DEFAULT); }
    static std::string set_bg_default() { return TC::set(BG_DEFAULT); }
