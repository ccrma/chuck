...
public:
    ...
    { this->set( offset ); m_is_object = is_object; m_type = te_none;
      m_is_external = FALSE; }
    
    // was this object reference? (added 1.3.0.0)
    t_CKBOOL m_is_object;

    // REFACTOR-2017: was this external variable?
    t_CKBOOL m_is_external;
    // and what was its name? (added 1.3.6.0)
    std::string m_name;
    te_Type m_type;
...
public:
    ...
    { this->set( offset ); m_type = te_none; m_is_external = FALSE; }
